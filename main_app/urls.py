...
urlpatterns = [
    ...
    path('gardens/<int:garden_id>/plots/<int:plot_id>/plants/<int:pk>/', views.PlantDetail.as_view(), name='plant-detail'),
    path('plants/<int:pk>/update/', views.UpdatePlant.as_view(), name='plant-update'),
