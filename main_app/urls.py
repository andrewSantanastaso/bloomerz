...
urlpatterns = [
    ...
    path('gardens/<int:garden_id>/', views.garden_detail.as_view(), name='garden-detail'),
    ...
    path('gardens/<int:garden_id>/plots/', views.plot_index.as_view(), name='plot-index'),
    ...
    path('gardens/<int:garden_id>/plots/<int:plot_id>/plants/', views.plant_index, name='plant-index'),
